...
class pars:
    MYDIR='/w/halld-scshelf2101/halld3/home/ihossain/t_reconstruction_55_60'
    inputThetaList='2_theta_values.list'
...
def makeSLURMJob():
    ...
    while line:
       ...
       reco_command1 = "{0}/eicdirc ".format(pars.dircmacrosTopDir) + "-i " + inputfile + "-u " + lutfile + "-r 2 -timecut 0.5 -v 2 -e 0 -trackingres 0.0005 -x mix_pik -timeres 0.1"

       reco_command2 = "{0}/eicdirc ".format(pars.dircmacrosTopDir) + "-i " + inputfile + "-u " + lutfile + "-r 4 -timecut 0.5 -v 2 -e 0 -trackingres 0.0005 -x mix_pik -timeres 0.1"
 
       reco_command3 = "{0}/eicdirc ".format(pars.dircmacrosTopDir) + "-i " + inputfile + "-u " + lutfile + "-pdf " + pdffile + "-r 2 -timecut 0.5 -v 2 -e 0 -trackingres 0.0005 -x mix_pik -timeres 0.1"
